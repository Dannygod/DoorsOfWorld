...
const westDoors = [
    ...
    },
    {
        ...
        description: `丁一世在312年的米爾維安橋戰役中取得的勝利而建，對於君士坦丁的統治至關重要，因為它幫助他打敗了競爭對手馬克森提烏斯，最終成為羅馬唯一的皇帝。拱門是他戰爭勝利的象徵。君士坦丁的勝利後，他成為羅馬帝國的基督教保護者，並在313年發布了米蘭敕令，使基督教成為合法宗教，這個轉折點對西方歷史和基督教的擴展至關重要。`,
        image: "./img/君士坦丁凱旋門.jpg",
        alt: "君士坦丁凱旋門"
    },
    {
        title: "梅嫩門 Menin Gate",
